<?php 
    ...
    $edit = $_GET['nim'];
    $login = mysqli_query($koneksi,"select * from mahasiswa where nim='$edit'");
    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div action="update.php" method="post" class="row">
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header"><strong>EDIT INFORMASI PERSONAL</strong></div>
                                    <div class="card-body">
                                        ...
                                        <form action="update.php" method="post" novalidate="novalidate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input readonly="" id="cc-pament" name="nim" type="text" class="form-control" aria-required="true" aria-invalid="false" value="<?php echo $tampil['nim']; ?>">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input readonly="" id="cc-pament" name="tahunmasuk" type="text" class="form-control" aria-required="true" aria-invalid="false" value="<?php echo $tampil['tahunmasuk']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Status Sebagai Mahasiswa</label>
                                                <input readonly="" id="cc-pament" name="status" type="text" class="form-control" aria-required="true" aria-invalid="false" value="<?php echo $tampil['status']; ?>">
                                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header"><strong>EDIT KONTAK</strong></div>
                                    <div class="card-body">
                             ...
                             <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header"><strong>EDIT ALAMAT</strong></div>
                                    <div class="card-body">
