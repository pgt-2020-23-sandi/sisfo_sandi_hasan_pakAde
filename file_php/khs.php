                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="table-responsive table--no-card m-b-30">
                                     <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>Semester 1</h3>
                                    <table class="table table-borderless table-striped table-earning">
                                       ...
                                       <tbody>
                                        <?php 
                                        $no = 1;
                                        $data = mysqli_query($koneksi,"select * from nilaiakademik where semester='1' and nim='$username'");
                                        while($d = mysqli_fetch_array($data)){
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $d['kuis']; ?></td>
                                                <td><?php echo $d['akhir']; ?></td>
                                                <td><?php echo $d['angka']; ?></td>
                                                <td><?php echo $d['huruf']; ?></td>
                            ...
                            <div class="col-lg-9">
                                <div class="table-responsive table--no-card m-b-30">
                                     <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>Semester 2</h3>
                                    <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            <tr>
                                                <th>No.</th>
                                       ...
                                       <tbody>
                                        <?php 
                                        $no = 1;
                                        $data = mysqli_query($koneksi,"select * from nilaiakademik where semester='2' and nim='$username'");
                                        while($d = mysqli_fetch_array($data)){
                                            ?>
                                            <tr>
                                                <td><?php echo $no++; ?></td>
                            ...
                            <div class="col-lg-9">
                                <div class="table-responsive table--no-card m-b-30">
                                     <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>Semester 3</h3>
                                    <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            <tr>
                                                <th>No.</th>
                                       ...
                                       <tbody>
                                        <?php 
                                        $no = 1;
                                        $data = mysqli_query($koneksi,"select * from nilaiakademik where semester='3' and nim='$username'");
                                        while($d = mysqli_fetch_array($data)){
                                            ?>
                                            <tr>
                                                <td><?php echo $no++; ?></td>
                            ...
                            <div class="col-lg-9">
                                <div class="table-responsive table--no-card m-b-30">
                                     <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>Semester 4</h3>
                                    <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            <tr>
                                                <th>No.</th>
                                       ...
                                       <tbody>
                                        <?php 
                                        $no = 1;
                                        $data = mysqli_query($koneksi,"select * from nilaiakademik where semester='4' and nim='$username'");
                                        while($d = mysqli_fetch_array($data)){
                                            ?>
                                            <tr>
                                                <td><?php echo $no++; ?></td>
                            ...
                            <div class="col-lg-9">
                                <div class="table-responsive table--no-card m-b-30">
                                     <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>Semester 5</h3>
                                    <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            <tr>
                                                <th>No.</th>
                                       ...
                                       <tbody>
                                        <?php 
                                        $no = 1;
                                        $data = mysqli_query($koneksi,"select * from nilaiakademik where semester='5' and nim='$username'");
                                        while($d = mysqli_fetch_array($data)){
                                            ?>
                                            <tr>
                                                <td><?php echo $no++; ?></td>
                            ...
                            <div class="col-lg-9">
                                <div class="table-responsive table--no-card m-b-30">
                                     <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>Semester 6</h3>
                                    <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            <tr>
                                                <th>No.</th>
                                       ...
                                       <tbody>
                                        <?php 
                                        $no = 1;
                                        $data = mysqli_query($koneksi,"select * from nilaiakademik where semester='6' and nim='$username'");
                                        while($d = mysqli_fetch_array($data)){
                                            ?>
                                            <tr>
                                                <td><?php echo $no++; ?></td>
