...
<head>
    ...
    <link href="dashboard/vendor/vector-map/jqvmap.min.css" rel="stylesheet" media="all">
...
<body class="animsition">
    ...
    <script src="dashboard/vendor/vector-map/jquery.vmap.js"></script>
    <script src="dashboard/vendor/vector-map/jquery.vmap.min.js"></script>
    <script src="dashboard/vendor/vector-map/jquery.vmap.sampledata.js"></script>
    <script src="dashboard/vendor/vector-map/jquery.vmap.world.js"></script>
    <script src="dashboard/vendor/vector-map/jquery.vmap.brazil.js"></script>
    <script src="dashboard/vendor/vector-map/jquery.vmap.europe.js"></script>
    <script src="dashboard/vendor/vector-map/jquery.vmap.france.js"></script>
    <script src="dashboard/vendor/vector-map/jquery.vmap.germany.js"></script>
    <script src="dashboard/vendor/vector-map/jquery.vmap.russia.js"></script>
    <script src="dashboard/vendor/vector-map/jquery.vmap.usa.js"></script>
